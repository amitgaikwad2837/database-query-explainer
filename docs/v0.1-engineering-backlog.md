# v0.1 Engineering Backlog - Database Query Explainer

## 1. Release Objective

- Product Type: CLI
- Primary Command/API: query-explain
- v0.1 Goal: Explain slow SQL and suggest indexing or query rewrites with migration SQL.
...
sql query, schema metadata, optional explain plan

### Outputs

problem diagnosis, optimized query suggestion, index migration script
...
- Core Acceptance Test: Given slow query fixture, tool identifies full table scan and generates index suggestion SQL.
